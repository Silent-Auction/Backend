define({ "api": [
        ...
        "request": [
          {
            ...
            "type": "Date",
            "optional": false,
            "field": "auctions.date_starting",
            "description": "<p>Start Date of Auction</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "content": [
          ...
          },
          {
            ...
            "type": "Date",
            "optional": false,
            "field": "auction.date_starting",
            "description": "<p>Starting date of auction</p>"
          },
          {
            "group": "content",
            "type": "Date",
  ...
  },
  {
    ...
    "description": "<p>Auctions cannot be edited after the end date has passed. You cannot edit the name, starting price, and start date of the auction after a bid has been placed on it.</p>",
    "group": "Auctions",
    "parameter": {
      "fields": {
        "param": [
        ...
        "request": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "date_starting",
            "description": "<p>End Date of Auction. Cannot edit after a bid has been placed</p>"
          },
          {
            "group": "request",
            "type": "Date",
