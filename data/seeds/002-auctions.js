...
exports.seed = function(knex) {
  return knex('auctions').insert([
        ...
        {user_id: 1, name:"Pixel Plus", description: "A Google Pixel", date_starting: new Date("10/10/2019"), date_ending: new Date("10/20/2019"), starting_price: 100, image: "https://static.bhphoto.com/images/images1000x1000/1550057716_1448921.jpg"}
      ]);
};
