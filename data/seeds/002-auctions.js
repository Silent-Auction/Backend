  ...
  return knex('auctions').truncate()
    .then(function () {
      ...
      return knex('auctions').insert([
        ...
        {user_id: 1, name:"Pixel Plus", description: "A Google Pixel", date_ending: new Date("10/20/2019"), starting_price: 100, image: "https://static.bhphoto.com/images/images1000x1000/1550057716_1448921.jpg"}
      ]);
    });
};
